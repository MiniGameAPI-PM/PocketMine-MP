    ...
    public function handlePlayerAction(PlayerActionPacket $packet) : bool{
        ...
        switch($packet->action){
            ...
            case PlayerActionPacket::ACTION_START_SWIMMING:
                $block = $this->player->getLevel()->getBlock($this->player);

                $ev = new PlayerToggleSwimEvent($this->player, true);
                ...
                if($ev->isCancelled()){
                    ...
                    $this->player->getDataPropertyManager()->setFloat(Player::DATA_BOUNDING_BOX_HEIGHT, $this->player->width);
                    $this->player->height = $this->player->width;
                    $this->player->setScale($this->player->getScale()); //why recalculateBoundingBox() is protected......
                    $this->player->setSwimming(true);
                }
                return true;
            case PlayerActionPacket::ACTION_STOP_SWIMMING:
                $ev = new PlayerToggleSwimEvent($this->player, false);
                $this->player->getServer()->getPluginManager()->callEvent($ev);
                if($ev->isCancelled()){
                    $this->sendData($this->player);
                }else{
                    $this->player->getDataPropertyManager()->setFloat(Player::DATA_BOUNDING_BOX_HEIGHT, get_class_vars(get_class($this->player))['height'] * $this->player->getScale());
                    $this->player->setScale($this->player->getScale());
